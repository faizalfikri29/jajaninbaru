...
<body>
    ...
    <div class="home">
        ...
        <a type="button" class="btn btn-dark btn-custom" href="produk.php">Shop Now</a>
    </div>
    ...
    <div class="container mb-4 mt-5">
        ...
        <div class="see-more-button mb-3">
            <a class="btn btn-primary mt-3 col-lg-3" href="produk.php">Lihat Lebih Banyak <i class="fas fa-chevron-right"></i></a>
        </div>
        <div class="row">
            <?php
